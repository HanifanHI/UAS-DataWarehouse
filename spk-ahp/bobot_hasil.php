...
<div class="container">
	<section class="content">
		...
		<table class="ui collapsing celled blue table table-striped">
			<thead>
				<tr>
					<th>Kriteria</th>
					<?php
		...
		<table class="ui celled red table table-striped">
			<thead>
				<tr>
					<th>Kriteria</th>
					<?php
		...
		?>
			...
			<a href='javascript:history.back()'>
				<button class="ui left labeled icon button bg-light">
