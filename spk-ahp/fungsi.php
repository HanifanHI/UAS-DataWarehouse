...
function getEigenVector($matrik_a, $matrik_b, $n)
{
	...
	for ($i = 0; $i <= ($n - 1); $i++) {
		...
		// $eigenvektor1 += ($matrik_b[$i] / (($eigenvektor) / $n));
	}
	return $eigenvektor;
}
...
?>
	...
	<div class="container">
		<form class="ui form" action="proses.php" method="post">
			<table class="ui celled selectable collapsing table table-striped">
				<thead>
					<tr>
			...
			<input class="ui submit button bg-primary text-white" type="submit" name="submit" value="SUBMIT">
		</form>
	</div>
	<br><br><br>
